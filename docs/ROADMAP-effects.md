...
| **Porteur / riposte** (`onDamageToBearer`)        | ~~cape-du-prespic~~ ✅ ~~anneau-du-prespic~~ ✅ (W48) ; reste dora                                                    | Riposte **FAITE (W48)** : bus `bearerFrames` activé + op `damageRiposteSource` (Cape/Anneau du Prespic + 2 réimpressions). Reste **dora** = « Piochez … si le Porteur est attaquant/bloqueur » (condition de RÔLE DE COMBAT du Porteur — cond continue différente de la riposte).                                                                       |
