...
async function migrateDatabase() {
  try {
    ...
    if (!supabaseUrl || !supabaseServiceKey) {
      ...
      console.error('Assurez-vous d\'avoir défini VITE_SUPABASE_URL et SUPABASE_SERVICE_KEY dans votre fichier .env');
      ...
      console.log('5. Recherchez "service_role key" (NE PAS utiliser la clé anon)');
