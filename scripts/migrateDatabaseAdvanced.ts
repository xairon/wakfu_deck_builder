...
async function migrateDatabase() {
  ...
  if (
    ...
    console.error(
      "❌ Informations de connexion PostgreSQL manquantes. Veuillez définir les variables d'environnement:"
    )
...
PG_PASSWORD=votre-mot-de-passe
    ...
    console.log(
      '5. Faites défiler jusqu\'à "Connection string" puis cliquez sur "Connection parameters"'
    )
