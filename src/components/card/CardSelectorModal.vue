      ...
      <div class="modal-box w-11/12 max-w-5xl max-h-screen overflow-y-auto">
        ...
        <div class="flex flex-wrap gap-2 mb-4">
          ...
          <select
            ...
            class="select select-bordered min-w-[180px]"
          >
              ...
              <div class="flex items-center gap-2">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center justify-between mt-1">
                    <!-- Statut dans le deck -->
                    <div
                      v-if="getCardInDeck(cardData.card.id)"
                    ...
                    <div class="flex items-center gap-1 text-xs">
                      ...
                      <span
                        ...
                        :class="{
                          'text-error':
                            cardData.quantity === 0 && onlyCollection,
                        }"
                      >
                        {{ cardData.quantity }}
                      </span>
        ...
        <div v-if="filteredCards.length === 0" class="alert alert-info mt-4">
          ...
          <span
            >Aucune carte ne correspond à vos critères. Essayez de modifier vos
            filtres.</span
          >
        </div>
