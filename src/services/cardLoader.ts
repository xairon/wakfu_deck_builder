...
function normalizeCardElements(card: any): void {
  // Orbe imprimé (« Élément : [X] ») — même normalisation de casse que niveau/force.
  if (card.element) {
    card.element = capitalizeElement(card.element);
  }
